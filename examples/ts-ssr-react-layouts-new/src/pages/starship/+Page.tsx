...
const Page = () => {
  ...
  return (
    <>
      ...
      <p>
        <b>
          Outer layout is preserved when navigating the nested layout:{" "}
          <Counter />
        </b>
      </p>
      <br />
      <div>
        <Link href="/starship">Overview</Link>{" "}
        <Link href="/starship/reviews">Reviews</Link>{" "}
...
type InnerViewProps = { view: ViewType };
const InnerView = ({ view }: InnerViewProps) => {
  if (view === "overview") {
    return <Overview />;
  }
  if (view === "reviews") {
